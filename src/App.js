...
function App() {
  ...
  return (
    <div>
      ...
      <Carousel responsive={responsive} className='mt-24 flex space-x-12'>
        ...
        <div><BelowCard text="Design & Develop BERT Question Answering model explanations with visualization" name="Aditya P" date="October 17 2022" image={Images.img4} /></div>
      </Carousel>
